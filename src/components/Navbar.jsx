...
const Navbar = () => {
  ...
  const toggleDropdown = () => setShowFilterOptions((prevState) => !prevState);
  ...
  return (
    <div className="flex justify-between items-center py-6 px-0 px-3 md-3 relative z-10" style={{ background: "#fff4f4" }}>
      ...
      <ul className="flex gap-6 list-none">
        <li>
          <a href="/cart" className="icon-link" onClick={() => navigate("/cart")}>
            {/* Cart Icon */}
            <svg width="2rem" height="2rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                fillRule="evenodd"
        ...
        <li>
          <a href="/profile" className="icon-link font-bold">Profile</a>
        </li>
      </ul>
    </div>
  );
