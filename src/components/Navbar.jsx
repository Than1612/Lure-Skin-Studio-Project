    ...
    return (
        <div className="flex justify-between items-center py-6 px-0 px-3 md-3 relative z-10" style={{ background: "#fff4f4" }}>
            ...
            <ul className="flex gap-6 list-none gap-12 prata-regular ">
                <li className="relative focus:outline-none flex bg-transparent border-none" onClick={toggleDropdown}> 
                    ...
                    {dropdownOpen && (
                        <div ref={dropdownRef} className="absolute mt-2 w-40 bg-white shadow-lg rounded-md transition duration-300 ease-in-out">
                ...
                <li className="relative focus:outline-none flex bg-transparent border-none" onClick={toggleDropdown2}>
                    
                        Shop<svg width="1rem" height="1rem" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {dropdownOpen2 && (
                        <div ref={dropdownRef2} className="absolute mt-2 w-40 bg-white shadow-lg rounded-md transition duration-300 ease-in-out">
                            <ul className="py-1 list-none text-left p-0">
                ...
                <li className="relative focus:outline-none flex bg-transparent border-none" onClick={toggleDropdown3}>
                     
                        Pages<svg width="1rem" height="1rem" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {dropdownOpen3 && (
                        <div ref={dropdownRef3} className="absolute mt-2 w-40 bg-white shadow-lg rounded-md transition duration-300 ease-in-out">
                            <ul className="py-1 list-none text-left p-0">
            ...
            <ul className="flex gap-6 list-none">
                <li><svg width="2rem" height="2rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
